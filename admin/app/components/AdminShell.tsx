...
const navItems = [
  ...
  { href: "/nexus/ai-server/", path: "/admin/nexus/ai-server/", label: "IA serveur", icon: RadioTower },
  { href: "/nexus/ai-server/prompts", path: "/admin/nexus/ai-server/prompts", label: "Prompts IA", icon: BrainCircuit },
  { href: "/nexus/seasonal-events", path: "/admin/nexus/seasonal-events", label: "Saisonnier", icon: Activity },
