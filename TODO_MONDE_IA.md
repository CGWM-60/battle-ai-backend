...
## A faire
- [ ] Completer la resolution des conflits: consequences, limites par joueur/continent, protection debutant avancee.
- [ ] Completer les regles guildes: permissions owner/officer, transfert owner, promotion/retrogradation stricte, contributions.
- [ ] Ajouter WebSocket/SSE pour le chat si le client en a besoin; conserver le polling pagine comme fallback.
