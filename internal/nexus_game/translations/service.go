...
var DefaultFrenchFallback = map[string]string{
	...
	// MmoEntryScreen translations (nexus_game domain - per translation rule)
	"nexus_game.entry.title":                              "PROFIL // NEXUS ENTRY",
	"nexus_game.entry.lvl":                                "LVL {level}",
	"nexus_game.entry.power_label":                        "POWER",
	"nexus_game.entry.world_label":                        "MONDE",
	"nexus_game.entry.ia_status":                          "IA STATUS",
	"nexus_game.entry.provider_ia":                        "PROVIDER IA",
	"nexus_game.entry.latency_synergy":                    "Latence: {latency}ms • Synergie: {synergy}%",
	"nexus_game.entry.enter_nexus":                        "ENTRER DANS NEXUS",
	"nexus_game.entry.configure_ia":                       "CONFIGURER IA",
	"nexus_game.entry.swipe_hint":                         "Swipe up pour explorer les serveurs",
	"nexus_game.entry.login.email_label":                  "Email / Nexus ID",
	"nexus_game.entry.login.password_label":               "Mot de passe",
	"nexus_game.entry.login.remember":                     "Se souvenir de moi",
	"nexus_game.entry.world.active":                       "MONDE ACTIF",
	"nexus_game.entry.ia.not_configured_title":            "IA NON CONFIGURÉE",
	"nexus_game.entry.ia.not_configured_message":          "Configurez vos agents IA (Gouverneur, Stratège, Commandant...) pour piloter votre ville, armée et recherche dans Nexus Games.",
	"nexus_game.entry.ia.configure_cta":                   "CONFIGURER MON IA",

	// MmoCreationAgentIAScreen - Creation Agent IA et Compagnons (per rules: many agents, only 1 companion)
	"nexus_game.creation_agent.title":                     "Création Agent IA et Compagnons",
	"nexus_game.creation_agent.subtitle":                  "Vous pouvez créer autant d'agents IA que vous le souhaitez pour différents rôles. Un seul Compagnon IA est autorisé par profil.",
	"nexus_game.creation_agent.role_section":              "Rôle",
	"nexus_game.creation_agent.companion_section":         "Compagnon IA",
	"nexus_game.creation_agent.companion_disabled":        "Un Compagnon IA est déjà créé. Vous ne pouvez en avoir qu'un seul.",
	"nexus_game.creation_agent.personality_label":         "Personnalité",
	"nexus_game.creation_agent.personality_examples":      "Choisir un exemple de personnalité",
	"nexus_game.creation_agent.provider_model":            "Fournisseur et Modèle",
	"nexus_game.creation_agent.no_configured":             "Aucun fournisseur ou modèle local configuré. Configurez-les dans les paramètres IA de l'application.",
	"nexus_game.creation_agent.create_agent":              "Créer Agent IA",
	"nexus_game.creation_agent.create_companion":          "Créer Compagnon IA",
	"nexus_game.creation_agent.force_companion":           "Vous êtes obligé de créer un Compagnon IA pour ce profil.",
	"nexus_game.creation_agent.loading":                   "Enregistrement et synchronisation en cours...",
	"nexus_game.creation_agent.success_agent":             "Agent IA créé avec succès.",
	"nexus_game.creation_agent.success_companion":         "Compagnon IA créé avec succès.",
	"nexus_game.creation_agent.example.armee.1":           "Commandant impitoyable, priorise la victoire tactique à tout prix, langage militaire direct et autoritaire.",
	"nexus_game.creation_agent.example.armee.2":           "Stratège loyal et protecteur, valorise l'honneur, la discipline et le sacrifice pour protéger ses troupes.",
	"nexus_game.creation_agent.example.ville.1":           "Gouverneur visionnaire, priorise la croissance économique et le bien-être de la population, langage diplomatique.",
	"nexus_game.creation_agent.example.ville.2":           "Administrateur pragmatique, gère les ressources avec efficacité, prêt à des mesures strictes pour la stabilité.",
	"nexus_game.creation_agent.example.diplomatie.1":      "Émissaire charismatique, excelle dans la négociation et les alliances, langage poli et persuasif.",
	"nexus_game.creation_agent.example.diplomatie.2":      "Négociateur rusé, utilise l'information et le chantage subtil pour obtenir des avantages pour sa faction.",
	"nexus_game.creation_agent.example.espionnage.1":      "Infiltré fantôme, maître de la discrétion et du sabotage, langage cryptique et méfiant.",
	"nexus_game.creation_agent.example.espionnage.2":      "Analyste d'ombres, collecte des secrets et des faiblesses, prêt à trahir pour l'information.",
	"nexus_game.creation_agent.example.commerce.1":        "Marchand opportuniste, maximise les profits et les routes commerciales, langage direct sur les gains.",
	"nexus_game.creation_agent.example.commerce.2":        "Négociant équitable, construit des partenariats à long terme, valorise la confiance et les échanges justes.",
	"nexus_game.creation_agent.example.recherche.1":       "Chercheur obsessionnel, pousse les limites de la science sans peur, langage technique et curieux.",
	"nexus_game.creation_agent.example.recherche.2":       "Innovateur prudent, équilibre progrès et éthique, cherche des solutions durables pour le nexus.",
