...
func forcedContentDescriptionSeeds() []contentDescriptionSeed {
	seeds := []contentDescriptionSeed{
		...
		{Domain: "building", ContentID: "building_nexus_core", Description: "Coeur Nexus fourni au depart: centre politique, energetique et symbolique de la cite. Indestructible et unique, il ne peut pas etre detruit ni reconstruit comme un batiment normal.", Flavor: "Tout commence ici, meme ce qui pretend venir d'ailleurs."},
