...
| GET | `/worlds/:id/players/:profileId/detail` | Path world id + profile gamer id | `{ "player": { "profile": ProfileGamer, "identity": { "world": World, "continent": Continent, "faction": Faction, "selectedAvatar": Avatar, "selectedCompanion": IACompanion }, "city": { "name": "...", "population": 0, "populationCapacity": 0, "morale": 50, "energyProduction": 0, "energyConsumption": 0, "energyBalance": 0, "energyStored": 0, "security": 50, "cityStats": PlayerCityStats }, "resources": [PlayerResource], "resourceCatalog": [ResourceCatalog], "buildings": [{ "playerBuilding": PlayerBuilding, "definition": BuildingDefinition }], "units": [{ "playerUnit": PlayerUnit, "definition": UnitDefinition }], "research": [{ "playerResearch": PlayerResearch, "definition": ResearchDefinition }], "queues": { "construction": [...] }, "avatars": [Avatar], "companions": [IACompanion], "agents": [MmoIAAgent], "resourceTransactions": [ResourceTransaction], "dailyGrantClaims": [DailyGrantClaim], "dailyPlans": [DailyPlan], "adminActions": [ServerAIAdminAction], "initialAllocation": InitialAllocationLog, "serverAI": { "memory": ServerAIPlayerMemory, "attacks": [ServerAIAttack], "sabotages": [ServerAISabotage], "espionage": [ServerAIEspionage], "aiOutputs": [AIOutput], "aiCallLogs": [ServerAICallLog] }, "generatedAt": "..." } }` |
