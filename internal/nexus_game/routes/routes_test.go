...
func TestRegisterRoutesMountsServerAIRoutes(t *testing.T) {
	...
	expected := []string{
		...
		"GET /api/nexus-game/admin/ai-server/jobs",
		"POST /api/nexus-game/admin/ai-server/jobs/run-due",
		"POST /api/nexus-game/admin/ai-server/jobs/run-all",
		"POST /api/nexus-game/admin/ai-server/jobs/:jobKey/run",
